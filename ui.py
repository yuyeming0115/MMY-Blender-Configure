...
class MMY_PT_ConfigPanel(bpy.types.Panel):
    bl_label = "MMY 配置管理"
    bl_idname = "MMY_PT_ConfigPanel"
...
def register():
    bpy.utils.register_class(MMY_PT_ConfigPanel)
...
def unregister():
    ...
    bpy.utils.unregister_class(MMY_PT_ConfigPanel)
